<section class="space-y-6">
    ...
    <!-- Modal Body -->
    <!-- se si vuole chiudere cliccando al di fuori della modale, eliminare l'ultimo endpoint: data-bs-backdrop e data-bs-keyboard -->
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p class="mt-1 text-sm text-gray-600">
                        {{ __('Una volta cancellato l\'account, tutte le sue risorse e i suoi dati saranno eliminati in modo permanente. Inserire la password per confermare la volontà di eliminare definitivamente il proprio account.') }}
                    </p>
                </div>
